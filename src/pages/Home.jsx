            ...
            <main className="space-y-6">
                <header className="flex flex-col items-center space-y-3 text-center">
                    <h1 className="text-2xl md:text-4xl font-extrabold text-slate-100 tracking-tight">
                        Gasolina y Diésel más Baratos Cerca de Ti
                    </h1>
                    <p className="text-sm md:text-base text-slate-400 max-w-2xl mx-auto">
                        Compara en tiempo real los precios oficiales del carburante en las estaciones de servicio de España más baratas de tu alrededor.
                    </p>
                </header>
